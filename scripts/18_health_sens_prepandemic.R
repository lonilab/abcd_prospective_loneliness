...
write_rds(
    health_res,
    here("outputs", "caches", "health_prepandemic_res.rds")
)
...
ggsave(
    ...
    filename = here("outputs", "figures", "corr_health_prepandemic_fig.pdf"),
    width = 8,
    height = 6,
    device = cairo_pdf
)
...
health_res |> 
    ...
    write_csv(here("outputs", "tables", "lmm_results_fu_prepandemic_health.csv"))
